/*
 * carboncombiner_asm1.c calculates the concentration (Ss) and flow rate when adding an external  
...
#define S_FUNCTION_NAME carboncombiner_asm1
...
static void mdlOutputs(double *y, double *x, double *u, SimStruct *S, int tid)
{
  ...
  if ((u[0] > 0) || (u[15] > 0)) {
    ...
    y[14]=(u[0]+u[15]);
    y[15]=u[16];
    y[16]=(u[17]*u[15])/(u[0]+u[15]);
    y[17]=(u[18]*u[15])/(u[0]+u[15]);
    y[18]=(u[19]*u[15])/(u[0]+u[15]);
    y[19]=(u[20]*u[15])/(u[0]+u[15]);
    y[20]=(u[21]*u[15])/(u[0]+u[15]);
  }
  else {
    y[0]=0;
    y[1]=0;
