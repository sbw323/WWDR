...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    ssSetNumInputs(        S, 3);   /* number of inputs                             (u[0] = qin 1 - upstream infiltration and   u[1] = qin2 - rain generation)       */
...
double HMAX, HINV, A, K, Kinf, Kdown, Kevap;
...
dx[0]=(1/A)*(qin1+u[1]-(Kevap*u[2]*0.024*A)-Kinf*sqrt(Hinf)-Kdown*x[0]);
