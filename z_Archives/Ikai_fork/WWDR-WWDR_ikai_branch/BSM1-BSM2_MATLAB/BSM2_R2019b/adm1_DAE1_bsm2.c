/*
 * The adm1_DAE1_bsm2.c is a C-file S-function level 2 for a speed-enhanced IAWQ AD Model No 1. 
 * In this the model derivatives of ion states are set to zero.
 * Instead they are calculated using algebraic equations and a pH solver
 * using the Newton-Raphson method. This way some stiffness is removed.
...
#define S_FUNCTION_NAME  adm1_DAE1_bsm2
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    ssSetInputPortWidth(S, 0, 40); /*(S, port index, port width) */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  real_T R, T_base, T_op, P_atm, k_P, P_gas, p_gas_h2o, q_gas, V_liq, procT8, procT9, procT10, p_gas_h2, p_gas_ch4, p_gas_co2, kLa, K_H_h2o_base, K_H_h2, K_H_h2_base, K_H_ch4, K_H_ch4_base, K_H_co2, K_H_co2_base, K_w, pK_w_base, factor;
  int_T i;
...
#define MDL_DERIVATIVES  /* Change to #undef to remove function */
  ...
  { 
   ...
   real_T R, T_base, T_op, K_H_h2o_base, K_H_co2_base, K_H_ch4_base, K_H_h2_base, factor;
   real_T P_atm, p_gas_h2o, kLa, K_H_co2, K_H_ch4, K_H_h2;
   real_T V_liq, V_gas;
   ...
   real_T p_gas_h2, p_gas_ch4, p_gas_co2, q_gas, k_P, P_gas;
