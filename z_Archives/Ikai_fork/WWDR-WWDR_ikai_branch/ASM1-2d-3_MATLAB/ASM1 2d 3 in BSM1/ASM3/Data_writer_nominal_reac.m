...
filename1 = sprintf('%sreactor1_data_nominal_iteration_%d.csv', folder_path, iteration);
filename2 = sprintf('%sreactor2_data_nominal_iteration_%d.csv', folder_path, iteration);
filename3 = sprintf('%sreactor3_data_nominal_iteration_%d.csv', folder_path, iteration);
filename4 = sprintf('%sreactor4_data_nominal_iteration_%d.csv', folder_path, iteration);
filename5 = sprintf('%sreactor5_data_nominal_iteration_%d.csv', folder_path, iteration);
