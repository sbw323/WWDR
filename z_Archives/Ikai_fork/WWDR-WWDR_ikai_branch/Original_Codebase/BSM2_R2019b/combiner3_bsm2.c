...
#define S_FUNCTION_NAME combiner3_bsm2
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    ssSetNumInputs(        S, 63);  /* number of inputs                      */
...
static void mdlOutputs(double *y, double *x, double *u, SimStruct *S, int tid)
{
  ...
  if ((u[14] > 0) || (u[35] > 0) || (u[56] > 0)) {
    ...
    y[2]=(u[2]*u[14] + u[23]*u[35]+ u[44]*u[56])/(u[14]+u[35]+u[56]);
    y[3]=(u[3]*u[14] + u[24]*u[35]+ u[45]*u[56])/(u[14]+u[35]+u[56]);
    y[4]=(u[4]*u[14] + u[25]*u[35]+ u[46]*u[56])/(u[14]+u[35]+u[56]);
    y[5]=(u[5]*u[14] + u[26]*u[35]+ u[47]*u[56])/(u[14]+u[35]+u[56]);
    y[6]=(u[6]*u[14] + u[27]*u[35]+ u[48]*u[56])/(u[14]+u[35]+u[56]);
    y[7]=(u[7]*u[14] + u[28]*u[35]+ u[49]*u[56])/(u[14]+u[35]+u[56]);
    y[8]=(u[8]*u[14] + u[29]*u[35]+ u[50]*u[56])/(u[14]+u[35]+u[56]);
    y[9]=(u[9]*u[14] + u[30]*u[35]+ u[51]*u[56])/(u[14]+u[35]+u[56]);
    y[10]=(u[10]*u[14] + u[31]*u[35]+ u[52]*u[56])/(u[14]+u[35]+u[56]);
    ...
    y[18]=(u[18]*u[14] + u[39]*u[35]+ u[60]*u[56])/(u[14]+u[35]+u[56]);
    y[19]=(u[19]*u[14] + u[40]*u[35]+ u[61]*u[56])/(u[14]+u[35]+u[56]);
    y[20]=(u[20]*u[14] + u[41]*u[35]+ u[62]*u[56])/(u[14]+u[35]+u[56]);
  }
  else {
    y[0]=0;
    y[1]=0;
