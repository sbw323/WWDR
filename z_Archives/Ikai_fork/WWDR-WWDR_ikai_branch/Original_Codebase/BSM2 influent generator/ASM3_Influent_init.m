...
% Initial ASM3 model concentrations
So_in   =  0.00;
Si_in   =  30.00;
Ss_in   =  69.50;
Snh_in  =  31.56;
...
% ASM3 kinetics and stoichiometrics
k_H = 3;
K_x = 1;
k_STO = 5;
n_NOX = 0.6;
...
ASM3_PARS = [k_H K_x k_STO n_NOX K_O2 K_NOX K_S K_STO Mu_H K_NH4 K_ALK bH_O2 bH_NOX bSTO_O2 bSTO_NOX   Mu_A KA_NH4 KA_O2 KA_ALK bA_O2 bA_NOX  f_SI YSTO_O2 YSTO_NOX YH_O2 YH_NOX Y_A f_XI iN_SI iN_SS iN_XI iN_XS iN_XB ISS_XI ISS_XS ISS_XB];
...
XSTO_fr    = 0.0;                           % XP as fraction of particulate COD
...
SNH_fr   = 1.0;                             % SNNH as fraction of ammonium N (strictly speaking not needed, but opens possibilities 
                                            % for developing influent models considering both ammonium and ammonia)
ASM3_FRACTIONS = [ SI_cst XI_fr XS_fr XBH_fr XBA_fr XSTO_fr SNO_fr SNH_fr];

%8.2 Noise parameters 

factor3 = 2;

% ASM3 noise parameters
...
ASM3_XINIT=[0.25 0.1 0.1 0.1 0.0 0.0];      % Initital conditions (7 states) XINIT= [TSS  XI  XS  XBH  XSTO  XA ]
...
ASM3_SEWERINIT =[zeros(1,17) 0.001];
