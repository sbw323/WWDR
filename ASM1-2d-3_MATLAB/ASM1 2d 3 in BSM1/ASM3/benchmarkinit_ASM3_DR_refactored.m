...
for segment = 1:total_segments
    ...
    seg_start = cal_time + (segment - 1) * pause_time;
    seg_end = cal_time + segment * pause_time;
    
    fprintf('\n--- Segment %d/%d (t=%.1f to %.1f days) ---\n', ...
        segment, total_segments, seg_start, seg_end);
    ...
    save('simulation_progress.mat', 'segment', 'total_segments');
end
