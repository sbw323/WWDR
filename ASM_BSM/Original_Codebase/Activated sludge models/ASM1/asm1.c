/*
 * asm1.c is a C-file S-function for IAWQ AS Model No 1 with temperature 
...
hH_NO3_end = mxGetPr(PAR)[24];
hA_NO3_end = mxGetPr(PAR)[25];
...
proc4 = b_H*(xtemp[7]/(K_OH+xtemp[7])+hH_NO3_end*K_OH/(K_OH+xtemp[7])*xtemp[8]/(K_NO+xtemp[8]))*xtemp[4];
proc5 = b_A*(xtemp[7]/(K_OH+xtemp[7])+hA_NO3_end*K_OH/(K_OH+xtemp[7])*xtemp[8]/(K_NO+xtemp[8]))*xtemp[5];
