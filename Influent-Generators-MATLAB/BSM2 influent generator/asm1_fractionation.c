...
if ((SI_cst*(u[11]-u[10])) <=CODsolflux){          /* SI is constant, direct rain water (u[10]) can dilute SI only */
    y[0] = SI_cst*(u[11]-u[10])/u[11];
    y[1] = (CODsolflux-SI_cst*(u[11]-u[10]))/u[11];
    }
...
y[2] = XI_fr*(u[1]+u[6])/u[11];                     /* XI defined as a fraction of the particulate COD */
y[3] = XS_fr*(u[1]+u[6])/u[11];                     /* XS defined as a fraction of the particulate COD */
y[4] = XBH_fr*(u[1]+u[6])/u[11];                    /* XBH defined as a fraction of the particulate COD */
y[5] = XBA_fr*(u[1]+u[6])/u[11];                    /* XBA defined as a fraction of the particulate COD */
y[6] = XP_fr*(u[1]+u[6])/u[11];                     /* XP defined as a fraction of the particulate COD */
y[7] = 0;                                           /* SO is assumed to be zero */
y[8] = SNO_fr*(u[4]+u[9])/u[11];                   /* SNO defined as the result of combining the inorganic N fluxes */
y[9] = SNH_fr*(u[2]+u[7])/u[11];                    /* SNH defined as the result of combining the ammonium N fluxes */
    
Norg=(u[3]+u[8]-u[2]-u[7])/u[11]-i_XB*(y[4]+y[5])-i_XP*y[6];
